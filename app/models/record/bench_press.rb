module Record
  class BenchPress
    ...
    # スクワット各試技のバリテーション設定
    validates :benchpress_first_attempt, numericality: { allow_nil: true },
                                         if: :should_validate_benchpress_first_attempt_numericality?
    validates :benchpress_second_attempt, numericality: { allow_nil: true },
                                          if: :should_validate_benchpress_second_attempt_numericality?
    validates :benchpress_third_attempt, numericality: { allow_nil: true },
                                         if: :should_validate_benchpress_third_attempt_numericality?
    ...
    validate :benchpress_first_attempt_is_not_be_not_attempted,
             unless: :should_validate_benchpress_first_attempt_numericality?
    validate :benchpress_second_attempt_is_not_be_not_attempted,
             unless: :should_validate_benchpress_second_attempt_numericality?
    validate :benchpress_third_attempt_is_not_be_not_attempted,
             unless: :should_validate_benchpress_third_attempt_numericality?
