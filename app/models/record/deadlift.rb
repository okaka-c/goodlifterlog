module Record
  class Deadlift
    ...
    def deadlift_first_attempt_is_not_be_not_attempted
      if deadlift_first_attempt.present? && Float(deadlift_first_attempt,
                                                  exception: false) >= 0 && deadlift_first_attempt_result == 'not_attempted'
    ...
    def deadlift_second_attempt_is_not_be_not_attempted
      if deadlift_second_attempt.present? && Float(deadlift_second_attempt,
                                                   exception: false) >= 0 && deadlift_second_attempt_result == 'not_attempted'
    ...
    def deadlift_third_attempt_is_not_be_not_attempted
      if deadlift_third_attempt.present? && Float(deadlift_third_attempt,
                                                  exception: false) >= 0 && deadlift_third_attempt_result == 'not_attempted'
